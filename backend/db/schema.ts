...
import { pgTable, index, foreignKey, varchar, integer, bigint, boolean, unique, text, uuid, uniqueIndex, serial, type AnyPgColumn, smallint, json, primaryKey, pgMaterializedView, pgSequence, pgEnum, customType } from "drizzle-orm/pg-core"
...
export const passkey = pgTable("passkey", {
	...
	transports: varchar({ length: 256 }),
	name: varchar({ length: 128 }).default('Passkey').notNull(),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	...
	index().using("btree", table.userId.asc().nullsLast().op("int4_ops")),
	foreignKey({
