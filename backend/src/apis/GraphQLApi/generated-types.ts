...
export type ResolversInterfaceTypes<_RefType extends Record<string, unknown>> = ResolversObject<{
  File: ( Omit<AudioFile, 'creator'> & { creator: _RefType['User'] } ) | ( Omit<GifFile, 'creator'> & { creator: _RefType['User'] } ) | ( Omit<PhotoFile, 'creator'> & { creator: _RefType['User'] } ) | ( Omit<ProfilePictureFile, 'creator'> & { creator: _RefType['User'] } ) | ( Omit<VideoFile, 'creator'> & { creator: _RefType['User'] } );
  Item: ( Omit<AudioItem, 'creator' | 'file' | 'post'> & { creator: _RefType['User'], file: _RefType['AudioFile'], post: _RefType['Post'] } ) | ( Omit<GifItem, 'creator' | 'file' | 'post'> & { creator: _RefType['User'], file: _RefType['GifFile'], post: _RefType['Post'] } ) | ( Omit<ImageItem, 'creator' | 'file' | 'post'> & { creator: _RefType['User'], file: _RefType['PhotoFile'], post: _RefType['Post'] } ) | ( Omit<ProcessingItem, 'creator' | 'post'> & { creator: _RefType['User'], post: _RefType['Post'] } ) | ( Omit<VideoItem, 'creator' | 'file' | 'post'> & { creator: _RefType['User'], file: _RefType['VideoFile'], post: _RefType['Post'] } );
  Node: ( Omit<AudioItem, 'creator' | 'file' | 'post'> & { creator: _RefType['User'], file: _RefType['AudioFile'], post: _RefType['Post'] } ) | ( Omit<GifItem, 'creator' | 'file' | 'post'> & { creator: _RefType['User'], file: _RefType['GifFile'], post: _RefType['Post'] } ) | ( Omit<ImageItem, 'creator' | 'file' | 'post'> & { creator: _RefType['User'], file: _RefType['PhotoFile'], post: _RefType['Post'] } ) | ( KeywordExternal ) | ( PostExternal ) | ( Omit<ProcessingItem, 'creator' | 'post'> & { creator: _RefType['User'], post: _RefType['Post'] } ) | ( SessionExternal ) | ( UserExternal ) | ( Omit<VideoItem, 'creator' | 'file' | 'post'> & { creator: _RefType['User'], file: _RefType['VideoFile'], post: _RefType['Post'] } );
}>;
...
export type FileProcessingUpdateResolvers<ContextType = Context, ParentType extends ResolversParentTypes['FileProcessingUpdate'] = ResolversParentTypes['FileProcessingUpdate']> = ResolversObject<{
  affectedItems?: Resolver<Maybe<Array<ResolversTypes['ID']>>, ParentType, ContextType>;
...
export type MutationResolvers<ContextType = Context, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = ResolversObject<{
  ...
  uploadProfilePicture?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<MutationUploadProfilePictureArgs, 'file'>>;
}>;
