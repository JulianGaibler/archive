...
async function main() {
  ...
  try {
    ...
    console.log(chalk.bold.blue('📝 Configure environment variables\n'));
    ...
    for (const category of categories) {
      ...
      for (const variable of variables) {
        ...
        if (existingValue !== undefined && existingValue !== null &&
          ...
          console.log(chalk.green(`✓ ${variable.name}: ${displayValue || '(empty)'}`));
        } else {
    ...
    console.log(chalk.green(`✓ Environment file saved to: ${envFilePath}`));
