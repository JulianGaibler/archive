...
const logout: GraphQLFieldConfig<any, any, any> = {
    ...
    type: new GraphQLNonNull(GraphQLBoolean),
    resolve: async (parent, args, ctx: Context) => {
        const rv = await SessionActions.mDelete(ctx, ctx.tmp.token)
        if (rv) {
...
const unlinkTelegram: GraphQLFieldConfig<any, any, any> = {
    ...
    type: new GraphQLNonNull(GraphQLBoolean),
    resolve: async (parent, args, ctx: Context) => UserActions.mUnlinkTelegram(ctx),
}
...
const uploadProfilePicture: GraphQLFieldConfig<any, any, any> = {
    ...
    resolve: async (parent, args, ctx: Context) => UserActions.mUploadProfilePicture(ctx, args),
}

const clearProfilePicture: GraphQLFieldConfig<any, any, any> = {
    description: 'Deletes the profile picture of the current user.',
    type: new GraphQLNonNull(GraphQLBoolean),
    resolve: async (parent, args, ctx: Context) => UserActions.mClearProfilePicture(ctx),
}
...
const changeName: GraphQLFieldConfig<any, any, any> = {
    ...
    type: new GraphQLNonNull(GraphQLBoolean),
    resolve: async (parent, args, ctx: Context) => UserActions.mChangeName(ctx, args),
}
...
const setDarkMode: GraphQLFieldConfig<any, any, any> = {
    ...
    type: new GraphQLNonNull(GraphQLBoolean),
    resolve: async (parent, args, ctx: Context) => UserActions.mSetDarkMode(ctx, args),
}
...
const changePassword: GraphQLFieldConfig<any, any, any> = {
    ...
    resolve: async (parent, args, ctx: Context) => UserActions.mChangePassword(ctx, args),
}
